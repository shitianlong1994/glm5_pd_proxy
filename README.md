此脚本为九坤 glm5.2-w4a8c8 mooncake 1P1D(双机)部署方案
...
```bash
cd GLM5_Script/exec/1p1d_200k_1k
chmod u+x  run_server_p_200k_1k_0601.sh
RUN_DCP=1 ./run_server_p_200k_1k_0601.sh
```

#### d节点服务拉起
```bash
cd GLM5_Script/exec/1p1d_200k_1k
chmod u+x  run_server_d_200k_1k_0601.sh
RUN_DCP=1 ./run_server_d_200k_1k_0601.sh
```
...
```bash
cd GLM5_Script/exec/1p1d_200k_1k
chmod u+x  run_proxy_200k_1k_0601.sh
RUN_DCP=1 ./run_proxy_200k_1k_0601.sh
```